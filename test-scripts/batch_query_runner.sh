...
if [ $# -lt 2 ]; then
    echo "Usage: $0 <rpc_url> <param_query_data> [concurrent_requests]"
    echo ""
    echo "Arguments:"
    echo "  rpc_url             - The RPC endpoint URL (e.g., http://localhost:26657)"
    echo "  param_query_data    - The base64 encoded simulation data"
...
execute_curl() {
    ...
    local data='{"id":"'$request_num'","jsonrpc":"2.0","method":"abci_query","params":["vm/qeval","'${PARAM_QUERY_DATA}'","0",false]}'
...
{
    echo "=================================================="
    echo "          BATCH QUERY RESULTS SUMMARY             "
    echo "=================================================="
    echo ""
