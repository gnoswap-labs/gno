...
import (
	...
	sm1 "github.com/gnoswap-labs/gno/tm2/pkg/amino/genproto/example/submodule"
...
// imports
import "github.com/gnoswap-labs/gno/tm2/pkg/amino/genproto/example/submodule2/submodule2.proto";`)

	p3doc = p3c.GenerateProto3SchemaForTypes(sm1.Package, reflect.TypeOf(obj))
	assert.Equal(t, p3doc.Print(), `syntax = "proto3";
package submodule;

option go_package = "github.com/gnoswap-labs/gno/tm2/pkg/amino/genproto/example/submodule/pb";
