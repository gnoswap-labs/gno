...
func Test_writeReadLedgerInfo(t *testing.T) {
	...
	lInfo := newLedgerInfo("some_name", tmpKey, *hd.NewFundraiserParams(5, testCoinType, 1))
	...
	assert.Equal(t,
		"gpub1pgfj7ard9eg82cjtv4u4xetrwqer2dntxyfzxz3pqddddqg2glc8x4fl7vxjlnr7p5a3czm5kcdp4239sg6yqdc4rc2r5cjrffs",
		crypto.PubKeyToBech32(lInfo.GetPubKey()))
